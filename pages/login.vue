        ...
        <template #content>
          <form @submit.prevent="handleLogin" class="login-form">
            ...
            <div class="form-field">
              <div class="flex align-items-center justify-content-between">
                <div class="flex align-items-center">
                  <Checkbox id="rememberMe" v-model="rememberMe" :binary="true" inputId="rememberMe" />
                  <label for="rememberMe" class="ml-2">{{ $t('shop.auth.rememberMe') }}</label>
                </div>
                <Button link class="p-0 forgot-password" @click="$event.preventDefault()">
            ...
            <div class="register-link">
              ...
              <Button link class="p-0" @click="goToRegister">{{ $t('shop.auth.register') }}</Button>
            </div>
          </form>
        </template>
      </Card>
